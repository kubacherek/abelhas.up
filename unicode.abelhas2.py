...
def usage():
    ...
    print '-r,--recursive\t\t wysyla zawartosc katalogu (oraz wszystkich podkatalogow) na chomika do wskazanego katalogu. Na chomiku tworzona jest cala struktura podkatalogow. PrzykLad:',
    print 'python', sys.argv[0], '-r "/katalog1/katalog2/katalog3" "/home/nick/Dokumenty"'
    print '-u,--upload\t\t wysyla plik na chomika do wskazanego katalogu.PrzykLad:',
